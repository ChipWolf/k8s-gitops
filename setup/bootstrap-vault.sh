...
loadSecretsToVault() {
  ...
  vault kv put secrets/flux-system/discord-webhook address="$FLUX_DISCORD_WEBHOOK_URL"
  vault kv put secrets/cert-manager/route53-credentials aws-secret-access-key="$CERT_MANAGER_AWS_SECRET_ACCESS_KEY"
